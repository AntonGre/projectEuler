...
*/
const PrimeService_1 = require("../../shared/lib/service/PrimeService");
const LIMIT = 1000000;
let service = new PrimeService_1.PrimeService();
let primeCollection = [2];
let obj = { prime: 0, primes: [] };
...
function consecutivePrime(targetPrime, primes) {
